...
Conflicts: kernel-adaptation-CONFLICT
%description
Kernel for HARDWARE.

%define kernel_version_build %{version}-SUFFIX
...
%package devel
Summary:    Devel files for HARDWARE kernel
Group:      Development/System
Requires:   %{name} = %{version}-%{release}
Provides:   kernel-devel = %{version}

%description devel
Devel for HARDWARE kernel
...
perl -p -i -e "s/^EXTRAVERSION.*/EXTRAVERSION = .KERNEL_EXTRA_VERSION-SUFFIX/" Makefile
...
echo The target hw is HARDWARE
